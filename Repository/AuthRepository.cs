...
namespace tparf.Repository
{
    public class AuthRepository:IAuthService
    {
        ...
        public async Task<AuthServiceResponseDto> MakeOwnerAsync(UpdatePermissionDto updatePermissionDto)
        {
            ...
            await _userManager.AddToRoleAsync(user, StaticUserRoles.MANUFACTURER);
        ...
        {
            bool isOwnerRoleExists = await _roleManager.RoleExistsAsync(StaticUserRoles.MANUFACTURER);
            ...
            await _roleManager.CreateAsync(new IdentityRole(StaticUserRoles.MANUFACTURER));
        ...
        {
            var authSecret = new SymmetricSecurityKey(Encoding.UTF8.GetBytes(_configuration.GetSection("JWT:Secret").ToString()));
